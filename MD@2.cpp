            ...
            while(1)
            {
                ...
                else if(f>=1149 && f<=1182 && g>=264 && g<=285)
                {
                    ...
                    else if(a>100.4&&d>=3)
                    {
                        ...
                        char x[7];
                        int number;
                        outtextxy(290,250,"Last       days your average body temperature was : ");
                        setcolor(15);
                        sprintf(x,"%d",d);
                        outtextxy(338,250,x);
                        sprintf(x,"%.2f",a);
        ...
        else if(f>=410 && f<=510 && g>=275 && g<=305)
        {
            ...
            while(1)
            {
                ...
                else if(d>3&&t>3)
                {
                    ...
                    serial(290,370,11);
                    int mn=316;
                    outtextxy(mn,370,"Loose & watery stool");
                    outtextxy(mn,400,"Cramping(painful involuntary contraction of a muscle,typically caused by fatigue or strain)");
                    outtextxy(mn,430,"Abdominal pain(Abdominal pain caused by menstruation,the part of the body containing the digestive and reproductive organs the belly");
                    outtextxy(mn,460,"Eating high-fiber foods");
                    outtextxy(mn,490,"Drug reaction for over dose");
                    outtextxy(mn,520,"Bloating");
                    outtextxy(mn,550,"Vomiting");
                    outtextxy(mn,550,"Nausea(a feeling of sickness with an inclination to vomit)");
                    outtextxy(mn,550,"Fever");
                    outtextxy(mn,550,"Blood,mucus or undigested food in the stool");
                    outtextxy(mn,550,"Weight loose");
                    rectangle(285,551,305,571);
                    setcolor(3);
                    outtextxy(290,620,"Choose your symptoms : ");
                    rectangle(520,615,660,650);
